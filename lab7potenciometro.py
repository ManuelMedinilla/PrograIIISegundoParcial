...
root = tk.Tk()
root.title("Controlador de Botones")
root.geometry("800x500")  # Ajustar el tamaño de la ventana
...
circles = []
for i in range(3):
    circle = canvas.create_rectangle(25 + i * 100, 50, 75 + i * 100, 100, outline="black", width=2, fill="white")  # Ajustar la posición y forma de los botones
